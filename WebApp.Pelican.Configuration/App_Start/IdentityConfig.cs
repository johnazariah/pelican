...
using WebApp.Pelican.Configuration;
using WebApp.Pelican.Configuration.Models;
...
namespace Microsoft.AspNet.Identity 
{
    public static class IdentityExtensions 
    {
        ...
        public static string GetUserId(this IIdentity identity) 
        {
            ...
            if (ci != null) 
            {
                return ci.FindFirstValue(WebApp.Pelican.Configuration.IdentityConfig.UserIdClaimType);
            }
            return String.Empty;
        }
